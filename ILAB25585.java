...
public class ILAB25585 {
	...
	@Test 
	public void Macron25585() throws IOException, InterruptedException {
		...
		if(driver.findElements(By.xpath("//a[@class='generate_quote']")).size()!=0)
		{
			...
			System.out.println("the title of the page is " +B);
			Thread.sleep(2000);
			...
			// Taking Screenshot of Setting first time enabling
			 driver.findElement(By.xpath("//*[@id='settings_generate_external_quotes_tr']/td[2]/div/label[1]")).click();
				...
				// Now Settings is enabled
				TakesScreenshot scrShot1 =((TakesScreenshot)driver);
				File SrcFile1=scrShot1.getScreenshotAs(OutputType.FILE);
				File DestFile1=new File("C:\\Users\\vishgarg\\OneDrive - Agilent Technologies\\Desktop\\Selenium\\ILAB25585-2.png");
				 FileUtils.copyFile(SrcFile1, DestFile1);
				 driver.get(url);
					Thread.sleep(2000);
					driver.findElement(By.xpath("//a[@class='generate_quote']")).click();
					String A = driver.getTitle();
					System.out.println("the title of the page is " +A);
		}
