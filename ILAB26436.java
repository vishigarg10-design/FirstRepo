...
@Test 
	...
	public void Macron26436() throws InterruptedException, IOException {
	...
	if(driver.findElements(By.xpath("//a[@class='generate_quote']")).size()!=0)
	{
		...
		String Terms = driver.findElement(By.xpath("//*[@id='quotation_form']/div[3]/div[10]/div[1]/label")).getText();
 		...
 		Thread.sleep(2000);
 		driver.findElement(By.id("quotation_terms")).sendKeys("the term and condition is displayed");
	...
	System.out.println("term and condition section is displayed");
	Thread.sleep(2000);
	driver.findElement(By.id("quotation_title")).sendKeys("Macron");
	Thread.sleep(1000);
	driver.findElement(By.id("quotation_customer_name")).sendKeys("Lola Paucek");
	...
	TakesScreenshot scrShot2 =((TakesScreenshot)driver);
	 ...
	 File DestFile2=new File("C:\\Users\\vishgarg\\OneDrive - Agilent Technologies\\Desktop\\Selenium\\ILAB26435.png");
