...
public class ILAB25652 {
	...
	public void Macron25652() throws InterruptedException, IOException {
		...
		if(driver.findElements(By.xpath("//a[@class='generate_quote']")).size()!=0)
		{
			...
			Thread.sleep(6000);
			driver.findElement(By.xpath("//table[@id='quotation-search-table']/tbody/tr[1]/td[6]/a[3]")).click();
			Thread.sleep(4000);
			TakesScreenshot scrShot2 =((TakesScreenshot)driver);
			File SrcFile2=scrShot2.getScreenshotAs(OutputType.FILE);
			File DestFile2=new File("C:\\Users\\vishgarg\\OneDrive - Agilent Technologies\\Desktop\\Selenium\\ILAB25652.png");
		...
		TakesScreenshot scrShot2 =((TakesScreenshot)driver);
		File SrcFile2=scrShot2.getScreenshotAs(OutputType.FILE);
		File DestFile2=new File("C:\\Users\\vishgarg\\OneDrive - Agilent Technologies\\Desktop\\Selenium\\ILAB25652-2.png");
		 FileUtils.copyFile(SrcFile2, DestFile2);
		driver.findElement(By.xpath("//table[@id='quotation-search-table']/tbody/tr[1]/td[6]/a[1]")).click();
		Thread.sleep(2000);
		driver.switchTo().alert().accept();
