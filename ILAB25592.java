...
public class ILAB25592 {
	...
	public void Macron25592() throws InterruptedException, IOException {
		...
		if(driver.findElements(By.xpath("//a[@class='generate_quote']")).size()!=0)
		{
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("//table[@id='quote_item_table']/tbody/tr[1]/td[8]")).click();
			Thread.sleep(1000);
			TakesScreenshot scrShot1 =((TakesScreenshot)driver);
			File SrcFile1=scrShot1.getScreenshotAs(OutputType.FILE);
			File DestFile1=new File("C:\\Users\\vishgarg\\OneDrive - Agilent Technologies\\Desktop\\Selenium\\ILAB25592.png");
		...
		File DestFile2=new File("C:\\Users\\vishgarg\\OneDrive - Agilent Technologies\\Desktop\\Selenium\\ILAB25592-2.png");
