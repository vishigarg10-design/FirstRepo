...
public class ILAB25651 {
	...
	@Test 
	public void Macron26651() throws IOException, InterruptedException {
		...
		if(driver.findElements(By.xpath("//a[@class='generate_quote']")).size()!=0)
		{
			...
			File DestFile=new File("C:\\Users\\vishgarg\\OneDrive - Agilent Technologies\\Desktop\\Selenium\\ILAB25261.png");
			 FileUtils.copyFile(SrcFile, DestFile);
			driver.findElement(By.xpath("//*[@id='quote_item_quantity_0']")).clear();
			Thread.sleep(2000);
			driver.findElement(By.xpath("//*[@id='quote_item_quantity_0']")).sendKeys("2");
			Thread.sleep(2000);
			TakesScreenshot scrShot1 =((TakesScreenshot)driver);
			File SrcFile1=scrShot1.getScreenshotAs(OutputType.FILE);
			File DestFile1=new File("C:\\Users\\vishgarg\\OneDrive - Agilent Technologies\\Desktop\\Selenium\\ILAB25261-2.png");
