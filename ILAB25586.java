...
public class ILAB25586 {
	...
	public void Macron25586() throws InterruptedException, IOException {
		...
		{
			System.out.println("the qoute generator settings is enabled");
			driver.get(url1);
			Thread.sleep(2000);
			...
			driver.get(url);
			Thread.sleep(2000);
			System.out.println("the settings are disabled now");
			
			TakesScreenshot scrShot2 =((TakesScreenshot)driver);
			File SrcFile2=scrShot2.getScreenshotAs(OutputType.FILE);
			File DestFile2=new File("C:\\Users\\vishgarg\\OneDrive - Agilent Technologies\\Desktop\\Selenium\\ILAB25586.png");
		...
		File DestFile1=new File("C:\\Users\\vishgarg\\OneDrive - Agilent Technologies\\Desktop\\Selenium\\ILAB25586-2.png");
