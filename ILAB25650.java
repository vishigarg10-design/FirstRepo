...
public class ILAB25650 {
	...
	public void Macron25650() throws IOException, InterruptedException {
		...
		if(driver.findElements(By.xpath("//a[@class='generate_quote']")).size()!=0)
		{
			...
			Thread.sleep(6000);
			WebElement Table = driver.findElement(By.id("quotation-search-table"));
			...
			for(WebElement m: rows) {
				...
				File DestFile2=new File("C:\\Users\\vishgarg\\OneDrive - Agilent Technologies\\Desktop\\Selenium\\ILAB25650.png");
				...
				for(WebElement m: rows) {
					...
					TakesScreenshot scrShot2 =((TakesScreenshot)driver);
					File SrcFile2=scrShot2.getScreenshotAs(OutputType.FILE);
					File DestFile2=new File("C:\\Users\\vishgarg\\OneDrive - Agilent Technologies\\Desktop\\Selenium\\ILAB25650-2.png");
					 FileUtils.copyFile(SrcFile2, DestFile2);
